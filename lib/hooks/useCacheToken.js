...
exports.getComputedToken = exports.extract = exports.default = exports.TOKEN_PREFIX = exports.PollCacheToken = void 0;
 ...
 */
function useCacheTokenHelper(theme, tokens) {
...
var rerenderTime = 1000;
var cacheArgs = null;
var setArgUpdate = null;
var cachedToken = [{
  blue: '#1677ff',
  purple: '#722ED1',
  cyan: '#13C2C2',
...
var _default = exports.default = function _default() {
  var _useState = (0, _react.useState)(0),
    ...
    cacheUpdate = _useState2[0],
    setCacheUpdate = _useState2[1];
  ...
  if (!cacheArgs || args[0] !== cacheArgs[0]) {
    ...
    if (setArgUpdate) {
      setTimeout(function () {
        return setArgUpdate(Math.random());
      }, 50);
    }
  }
...
var PollCacheTokenHelper = function PollCacheTokenHelper() {
  var _useState3 = (0, _react.useState)(0),
    _useState4 = (0, _slicedToArray2.default)(_useState3, 2),
    renderNonce = _useState4[0],
    setRenderNonce = _useState4[1];
  // @ts-ignore
  var res = useCacheTokenHelper.apply(void 0, (0, _toConsumableArray2.default)(cacheArgs));
  if (res) {
    cachedToken = res;
  }
...
var PollCacheToken = exports.PollCacheToken = /*#__PURE__*/_react.default.memo(function () {
  var _useState5 = (0, _react.useState)(0),
    _useState6 = (0, _slicedToArray2.default)(_useState5, 2),
    argUpdate = _useState6[0],
    _setArgUpdate = _useState6[1];
  setArgUpdate = _setArgUpdate;
  return cacheArgs ? /*#__PURE__*/_react.default.createElement(PollCacheTokenHelper, null) : null;
});